...
<body>
  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light navbar-float">
      <div class="container">
        <a href="index.php" class="navbar-brand">ALLY<span class="text-primary"></span></a>
        ...
        <div class="navbar-collapse collapse" id="navbarContent">
          ...
          <div class="ml-auto">
            <a href="login.php" class="btn btn-outline rounded-pill">Login</a>
          </div>
        </div>
      </div>
    </nav>
      ...
      <div class="container h-100">
        <div class="row align-items-center h-100">
          <div class="col-lg-6 py-3 wow fadeInUp">
            <h1 class="mb-4">It's time to care for the ones who cared for you.</h1>
            <p class="text-lg mb-5">WIth ALLY, you can help your family member's feel loved.</p>

            <a href="#" class="btn btn-outline border text-secondary">More Info</a>
            <a href="#" class="btn btn-primary btn-split ml-2">How to Use <div class="fab"><span class="mai-play"></span></div></a>
          </div>
          <div class="col-lg-6 py-3 wow zoomIn">
            <div class="img-place">
              <img src="assets/img/1.jpg" alt="vector image of elderly"/>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-center">
          <div class="col-md-6 col-lg-4 py-3 wow fadeInUp">
            <div class="d-flex flex-row">
              ...
              <div>
                ...
                <p>Photos of them along with their family and friends to remind them they are loved.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 py-3 wow fadeInUp">
            <div class="d-flex flex-row">
              ...
              <div>
                <h5>Reminders so they never forget.</h5>
                <p>Easy to navigate and effective reminders to never again forget medicines or food.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 py-3 wow fadeInUp">
            <div class="d-flex flex-row">
              ...
              <div>
                <h5>Games and More</h5>
                <p>Fun and engaging games and videos to make them feel good.</p>
              </div>
            </div>
          </div>
        </div>
